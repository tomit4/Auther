...
exports.passwordSchemaErrMsg = exports.passwordSchemaRegex = void 0;
const passwordSchemaRegex = new RegExp([
    ...
    .map(r => r.source)
    .join(''));
exports.passwordSchemaRegex = passwordSchemaRegex;
const passwordSchemaErrMsg = 'Password must be at least 10 characters in length and contain at \
                ...
                special character';
exports.passwordSchemaErrMsg = passwordSchemaErrMsg;
