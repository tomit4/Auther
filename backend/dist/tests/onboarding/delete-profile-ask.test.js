            ...
            handler: async (request, reply) => {
                ...
                try {
                    ...
                    if (actuallySendEmail) {
                        emailSent = await (0, send_email_1.default)(process.env.TEST_EMAIL, `verify-delete-pass/${hashedEmail}`, process.env
...
(0, ava_1.default)('sends a transac email to request deletion of profile', async (t) => {
    t.plan(3);
    ...
    if (!actuallySendEmail)
        t.log('Actual email functionality not tested in delete-password-ask route');
